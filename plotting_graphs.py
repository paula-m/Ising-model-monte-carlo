...
class plotting_graphs():
    ...
    def plot_glauber(self):
        ...
        #plt.plot(Temp[0:21], Magnetisation[21:42], color="purple", label="Absolute Magnetisation")
        ...
        #plt.errorbar(Temp[0:21], Suscept[21:42], yerr=Suserr[21:42], ecolor="purple")
        ...
        #plt.plot(Temp[0:21], Heat_cap[21:42])
